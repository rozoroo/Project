      ...
      <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
          <form class="form-inline" action="media.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <div class="input-group">
                <span class="input-group-btn">
                  ...
                  <label class="btn btn-primary btn-file" style="background-color: #fff; border-color: #ccc;">
                    Choose File
                    <input type="file" name="file_upload" multiple="multiple" style="display: none;" onchange="showFileName(event)" />
                  </label>
                </span>
            ...
            <!-- Display the selected file name inside the input box -->
            <div class="form-group mt-3" id="file-name-container" style="display: none;">
...
<!-- JavaScript to display the file name within the box -->
<script>
  function showFileName(event) {
    ...
    // Display the file name container inside the input box
