            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                ...
                <label class="btn btn-default btn-file">
                  Choose File
                  <input type="file" name="file_upload" class="file-input" onchange="showFileName(event)" style="display: none;" />
                </label>
                <!-- Text Input to Display File Name -->
                <input type="text" id="file-name" class="form-control" placeholder="No file selected" readonly style="border-left: 0;" />
              </div>
              <div class="form-group">
...
<!-- JavaScript to display the file name in the input box -->
<script>
